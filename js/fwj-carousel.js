(function ($) {
    ...
    function nv_showNavi(a, b, c) {
        ...
        if ("show" == b || "hide" == b) var e = b;
            ...
            debug(c, "Not enough items (" + b + " total, " + d + " needed): Ocultando navegação.");
            var e = "hide"
        } else var e = "show";
    ...
    function debug(a, b) {
        if (!is_undefined(window.console) && !is_undefined(window.console.log)) {
            ...
            b = is_string(b) ? "iShopping: " + b : ["carouFredSel" + c + ":", b], window.console.log(b)
        }
        return !1
    }
    $.fn.carouFredSel || ($.fn.caroufredsel = $.fn.carouFredSel = function (options, configs) {
        if (0 == this.length) return debug(!0, 'Nenhum elemento encontrado para "' + this.selector + '".'), this;
        ...
        FN._init = function (a, b, c) {
            ...
            FN._unbind_events(), $cfs.bind(cf_e("stop", conf), function (a, b) {
                ...
                }), !0) : debug(conf, "Não é um objeto válido.")
