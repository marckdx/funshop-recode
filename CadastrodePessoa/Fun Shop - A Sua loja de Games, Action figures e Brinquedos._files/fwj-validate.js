        ...
        newLang: function(){
            $.validationEngineLanguage.allRules = {
                ...
                "maxCheckbox": {
                    ...
                    "alertText2": " op&ccedil;ões permitidas"
                },
                "minCheckbox": {
                    "regex": "none",
                    "alertText": "* Favor selecionar ",
                    "alertText2": " op&ccedil;&atilde;o(ões)"
                },
                "equals": {
                    "regex": "none",
                    "alertText": "* Os campos n&atilde;o se correspondem."
                },
                "creditCard": {
                    "regex": "none",
                ...
                "email": {
                    ...
                    "alertText": "* Informe um endere&ccedil;o de e-mail v&aacute;lido."
                },
                "integer": {
                    "regex": /^[\-\+]?\d+$/,
                ...
                "url": {
                    ...
                    "alertText": "* A URL informada &eacute; inv&aacute;lida"
                },
                "onlyNumberSp": {
                    "regex": /^[0-9\ ]+$/,
                    "alertText": "* Aceito apenas n&uacute;meros"
                },
                "onlyLetterSp": {
                    "regex": /^[a-zA-Z\ \']+$/,
                    "alertText": "* Aceito apenas letras"
                },
                "onlyLetterNumber": {
                    "regex": /^[0-9a-zA-Z]+$/,
	 ...
	 var methods = {
			...
			if (errorFound) {
				if (options.scroll) {
					...
					if (options.isOverflown) {
						...
						$("html, body").animate({scrollTop: destination}, 900, function(){
							if(options.focusFirstField) first_err.focus();
						});
		...
		*/
		_custom: function(field, rules, i, options) {
			...
			var fn;
			if(!rule) {
				alert("Regra customizada n&atilde;o existe - "+customRule);
				return;
			}
...
//alert(field.val()+" != "+$("#" + equalsField).val());
		...
		*/
		_calculatePosition: function (field, promptElmt, options) {
			...
			switch (positionType) {
				...
				case "topLeft":
					promptTopPosition +=  fieldTop;
					promptleftPosition += fieldLeft - promptElmt.width() + fieldWidth + 10; 
					break;
		...
		*/
		 _saveOptions: function(form, options) {
			 ...
			 if ($.validationEngineLanguage)
			 	...
			 	$.error("Regras de valida&ccedil;&atilde;o n&atilde;o carregada, por favor verifique.");
