(function ($) {
    function Countdown() {
        ...
        this.regional[''] = {
            ...
            labels1: ['ANO', 'MÊS', 'SEM', 'DIA', 'HORA', 'MIN', 'SEG'],
    ...
    $.extend(Countdown.prototype, {
        ...
        _generateHTML: function (c) {
            ...
            var n = function (a) {
                ...
                return ((!c.options.significant && h[a]) || (c.options.significant && j[a]) ? '<div class="' + x._sectionClass + '">' + '<div class="' + x._amountClass + '">' + d._translateDigits(c, c._periods[a]) + '</div><label>' + (b ? b[a] : k[a]) + '</label></div>' : '')
            };
